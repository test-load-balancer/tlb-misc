  ...
  \begin{centering}
    \begin{itemize}
      ...
      \item {\color{green}Twist} using {\color{red}Ant} or {\color{red}Buildr} for {\color{blue}Java}
        \pause
      \item {\color{green}Rspec 1.x \& 2.x} using {\color{red}Rake} on {\color{blue}MRI}
        \pause
      \item {\color{green}Test::Unit} using {\color{red}Rake} on {\color{blue}MRI}
    \end{itemize}
  \end{centering}
\end{frame}
...
\begin{frame}{Working on...}
  \begin{centering}
    \begin{itemize}
    \item {\color{green}Junit} using {\color{red}Maven} on {\color{blue}Java}
      \pause
    \item {\color{green}Cucumber} using {\color{red}Rake} on both {\color{blue}MRI} and {\color{blue}JRuby}
      \pause
    \item {\color{green}Rspec 1.x \& 2.x} using {\color{red}Rake} on {\color{blue}JRuby}
      \pause
    \item {\color{green}Test::Unit} using {\color{red}Rake} on {\color{blue}JRuby}
    \end{itemize}
  \end{centering}
\end{frame}
